...
конструктор пусть имеет параметр, значение которого назначается переменным пате данного и 
...
классе Месрутщыус перезапишите метод swim так, чтобы он выводил на экран "Меченосец красивая рыба
